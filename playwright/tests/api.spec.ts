...
test.describe("Matchers example", async () => {
  test("toContainEqual example", async () => {
    //toContainEqual мачва по точно определени стойности и сравнява масиви само
    const users = [
      { id: 1, name: "Alice" },
      { id: 2, name: "Bob" },
    ];
  ...
  test("toEqual example", async () => {
    // toEqual мачва по точно определени стойности
  ...
  test("toMatchObject example", async () => {
    //toMatchObject мачва по определени пропъртита в обекта
    const user = {
      id: 1,
      name: "Alice",
      age: 30,
